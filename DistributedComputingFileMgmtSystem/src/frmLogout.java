...
public class frmLogout extends javax.swing.JFrame {
    ...
    public String logout(String username, String password) throws SocketException, UnknownHostException, UnknownHostException, IOException{
    ...
    private void btnLogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogoutActionPerformed
        JOptionPane.showMessageDialog(null, "You want to logout", "Logout", JOptionPane.INFORMATION_MESSAGE);
        if(txtUsername.getText().equals("") || txtPassword.getText().equals("")){
            JOptionPane.showMessageDialog(null, "You left empty fields", "Empty Fields", JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
            String logoutResult = logout(txtUsername.getText(), txtPassword.getText());
            JOptionPane.showMessageDialog(null,logoutResult,"Logout Result", JOptionPane.INFORMATION_MESSAGE);
        } catch (UnknownHostException ex) {
            Logger.getLogger(frmLogout.class.getName()).log(Level.SEVERE, null, ex);
