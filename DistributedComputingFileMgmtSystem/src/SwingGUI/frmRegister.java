...
public class frmRegister extends javax.swing.JFrame {
    ...
    public String register(String username, String password) throws SocketException, IOException, UnknownHostException{
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        JOptionPane.showMessageDialog(null, "You want to register", "Register", JOptionPane.INFORMATION_MESSAGE);
        ...
        try {
            registerResult = register(txtUsername.getText(), txtPassword.getText());
            JOptionPane.showMessageDialog(null,registerResult,"Register Result", JOptionPane.INFORMATION_MESSAGE);
